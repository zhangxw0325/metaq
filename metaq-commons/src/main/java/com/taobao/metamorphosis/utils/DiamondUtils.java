...
public class DiamondUtils {
     ...
     * @return
     */
    public static ZKConfig getZkConfig(final DiamondManager diamondManager, final long timeout) {
        final Properties props = diamondManager.getAvailablePropertiesConfigureInfomation(timeout);
        if (props != null) {
    ...
    public static void getPartitions(final DiamondManager diamondManager, final long timeout,
