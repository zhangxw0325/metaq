...
public class MetaZookeeper {
    ...
    public class ZKGroupDirs {
        public ZKGroupDirs(final String group) {
            ...
            this.consumerStandbyDir = this.consumerGroupDir + "/standby";
            this.consumerVersionDir = this.consumerGroupDir + "/version";
        }
        ...
        public String consumerStandbyDir;
        public String consumerVersionDir;
    }
