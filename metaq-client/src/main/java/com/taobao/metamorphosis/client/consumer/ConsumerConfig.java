...
public class ConsumerConfig extends MetaClientConfig {
    ...
    private long maxDelayFetchTimeInMills = 3000;
    @Deprecated
    private long maxDelayFetchTimeWhenExceptionInMills = 10000;
    private long fetchTimeoutInMills = 15000;
    ...
    // -1表示从master拉数据
    public static int PullFromMaster = -1;
    private int pullFromWhichServer = PullFromMaster;
    ...
    public int getPullFromWhichServer() {
        return pullFromWhichServer;
    }


    public void setPullFromWhichServer(int pullFromWhichServer) {
        this.pullFromWhichServer = pullFromWhichServer;
    }
}
